...
const MAP_STYLES: StyleEntry[] = [
  ...
  { id: "colorful", label: "Colorful", style: "/background/colorful.json" },
  { id: "neutrino", label: "Neutrino", style: "/background/neutrino.json" },
  { id: "graybeard", label: "Graybeard", style: "/background/graybeard.json" },
  { id: "eclipse", label: "Eclipse", style: "/background/eclipse.json" },
  { id: "shadow", label: "Shadow", style: "/background/shadow.json" },
